...
public class TypeBroadcastCommand extends CaptureSubCommand {
    
    public TypeBroadcastCommand(CLCapture plugin) {
        super("", plugin, true);
    }
    ...
    protected String execute(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        boolean doBroadcast = Boolean.parseBoolean(args[3]);

        type.get().setBroadcastStart(doBroadcast);
        return "New broadcast behavior set.";
    }
